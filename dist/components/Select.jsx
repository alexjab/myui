...
`;export default class extends e.Component{constructor(t){super(t),n(this,"onOptionClick",e=>{e.stopPropagation();const{target:{dataset:{value:t,label:n}}}=e;let l;this.setState(({selectedValue:e})=>(l=e,{selectedValue:t,selectedLabel:n,isOptionsVisible:!1}),()=>{if(l!==t){const{onChange:e,onChangeValue:t}=this.props,{selectedValue:n,selectedLabel:l}=this.state;e&&e({value:n,label:l}),t&&t(n)}})}),n(this,"onContainerClick",e=>{e.target.focus(),this.setState(({isOptionsVisible:e})=>({isOptionsVisible:!e}))}),n(this,"onContainerBlur",e=>{this.setState(({isOptionsVisible:e})=>({isOptionsVisible:!1}))}),n(this,"renderOptions",t=>{if(!t)return null;const{selectedValue:n}=this.state;return e.createElement(u,null,t.map((t,l)=>e.createElement(m,{key:l,"data-value":t.value,"data-label":t.label,onClick:this.onOptionClick,isSelected:t.value===n},t.label)))});const{defaultValue:l,options:i}=t;if(this.state={isOptionsVisible:!1,selectedValue:l||null,selectedLabel:null},l){const e=i.find(e=>e.value===l);e&&(this.state.selectedLabel=e.label)}}renderIcon(t){return t?e.createElement(d,null):e.createElement(h,null)}render(){const{children:t,options:n}=this.props,{isOptionsVisible:l,selectedValue:i,selectedLabel:o}=this.state;return e.createElement(a,{tabIndex:"0",onClick:this.onContainerClick,onBlur:this.onContainerBlur},e.createElement(c,null,e.createElement(p,{value:null===o?t:o},null===i?t:o),this.renderIcon(l)),this.renderOptions(l?n:null))}}
