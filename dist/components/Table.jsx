...
`;class u extends e.Component{constructor(...e){super(...e),r(this,"onSort",()=>{this.props.isSortable&&this.props.onSort(this.props.rowKey)})}render(){const{children:t,isSortable:r,sortOrder:o}=this.props;return e.createElement(d,{isSortable:r,onClick:this.onSort},e.createElement(h,null,t,r&&o?e.createElement(m,null,"asc"===o?e.createElement(s,{size:"1em"}):e.createElement(a,{size:"1em"})):null))}}u.defaultProps={theme:l};class y extends e.Component{constructor(e){super(e),r(this,"onSort",e=>{this.setState(({sortBy:t,sortOrder:r})=>{let o=null;return t&&t!==e?o="desc":"desc"===r?o="asc":null===r&&(o="desc"),{sortBy:e!==t?e:t,sortOrder:o}},()=>{this.props.onSort&&this.props.onSort(this.state.sortBy,this.state.sortOrder)})}),this.state={sortBy:e.defaultSortBy||null,sortOrder:void 0!==e.defaultSortBy?e.defaultSortOrder||"asc":null}}render(){const{headers:t,onSort:r,rows:o}=this.props,{sortBy:l,sortOrder:n}=this.state;return e.createElement(c,null,t?e.createElement("thead",null,e.createElement("tr",null,t.map(t=>e.createElement(u,{key:t.key,rowKey:t.key,isSortable:t.isSortable,onSort:this.onSort,sortOrder:l===t.key?n:null},t.title)))):null,o?e.createElement("tbody",null,o.map((r,o)=>e.createElement("tr",{key:o},t.map(t=>e.createElement(p,{key:t.key},r[t.key]))))):null)}}r(y,"defaultProps",{theme:l});export default y;
