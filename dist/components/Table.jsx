...
$export($export.S + $export.F * !__webpack_require__(/*! ./_iter-detect */ "./node_modules/core-js/modules/_iter-detect.js")(function (iter) { }), 'Array', {
...
Table.Header = ({
  ...
  return React.createElement(TableHeader, rest, React.createElement(TableHeaderLevel, null, children, isSortable ? React.createElement(TableHeaderIcon, null, React.createElement(Icon$1, {
    name: "arrow-down",
    size: "1em"
  })) : null));
};
...
class TableAuto extends React.Component {
  render() {
    ...
    }, header.title)))) : null, rows ? React.createElement(Table.Body, null, rows.map((row, rowIndex) => React.createElement(Table.Row, {
      key: rowIndex
